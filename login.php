...
$class ="w3-hide";
if(isset($_GET['notice']) && $_GET['notice'] == "failed"){
		$class="";
		$notice="Incorrect Username or Password. Try again.";
	}
?>
<!doctype html>
<html>
...
<body>
	<div class="w3-bar w3-border w3-grey w3-top">
		...
		<a href="#" class="w3-bar-item w3-button w3-mobile">SIMPLE CRUD</a>
	</div>
			...
			<h3>LOGIN:</h3>
				...
				<form method="post" action="">
					...
					<input class="w3-input w3-border w3-round" type="password" placeholder="Password" name="pass">
						<div class="separator"></div>
					<input class="w3-button w3-border w3-block w3-round" type="submit" value="LOGIN">
					<div class="separator"></div>
				</form>
				<a href="register.php"><button class="w3-button w3-block w3-border w3-round">REGISTER</button></a>
